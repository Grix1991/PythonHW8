...
def input_data():
    ...
    phone = phone_data()
    adress = adress_data()
    var = int(input(f"Какой вариант записи данных Вам нравится?\n\n"
                    f"1 Вариант:\n"
                    f"{name}\n"
                    f"{surname}\n"
                    f"{phone}\n"
                    ...
                    f"Выберите понравившийся номер варината: "))

    while var != 1 and var != 2:
        var = int(input("Такого варианта нет!Попробуте еще раз: "))
...
def delete_data():
    file_num = int(input(f'В каком файле Вы хотите удалить запись?:\n'
                        f'1 - Файл №1\n'
                        f'2 - Файл №2\n'))
